public class Heap {
    ...
    // the max item is the root node (index 0) in a max heap
    public int getMax() {
        return heap[0];
    }
    ...
    private void fixDown(int index) {
        ...
        // in a max heap the parent is allways larger than the children
        ...
        // compare the right child with the max(parent, leftChild)
        ...
        // otherwise the heap properties are not valid
    ...
    private void fixUp(int index) {
        ...
        // in maximum heap the parent is always larger
